...
export PATH=/home/lizhixin/softwares/anaconda3/envs/python2/bin:$PATH
...
# Run Jupyter
# /home/lizhixin/softwares/anaconda3/bin/jupyter notebook --NotebookApp.iopub_data_rate_limit=1e10 --no-browser --port=${port} --ip=${node} &&\
...
# /home/lizhixin/softwares/anaconda3/envs/my-rdkit-env/bin/jupyter

# python2
source activate python2
/home/lizhixin/softwares/anaconda3/envs/python2/bin/jupyter notebook --NotebookApp.iopub_data_rate_limit=1e10 --no-browser --port=${port} --ip=${node} &&\
