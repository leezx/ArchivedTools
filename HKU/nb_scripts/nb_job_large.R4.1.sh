...
export R_LIBS_USER=/home/lizhixin/softwares/R_lib_4
export R_LIBS=/home/lizhixin/softwares/R_lib_4
...
/home/lizhixin/softwares/anaconda3/envs/seurat4/bin/jupyter notebook --NotebookApp.iopub_data_rate_limit=1e10 --no-browser --port=${port} --ip=${node} &&\
